...
class GridForm(forms.Form):
    def __init__(self, *args,**kwargs):
        ...
        for i in xrange(0,self.rows):
            ...
            for j in xrange(0,self.cols):
                ...
                form_row.append(Div(field_name, css_class = "col-md-1 square_field"))
    ...
    def clean(self):
        ...
        for i in xrange(0,self.rows):
            ...
            for j in xrange(0,self.cols):
                try:
                    value = cleaned_data.get('%s_input_%s_%s'%(self.grid_name, i, j))
                    if value != '':
                        value = int(value)
                    ...
                    raise forms.ValidationError("Only Integer Values in range 1,9 allowed ")
